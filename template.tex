...
prediction or identification. Our literature review is focused on
...
filled by waves from the participants. Some of the famest risk scores
...
metric of 86\%. There are also numerous researches that deal with deep learning
...
\cite{Fregoso,KAVAKIOTIS2017104}. We can observe at a first glance two variances of 
diabetes studies. The Leicster Risk aims to identify the current health condition, 
while FINDRISC tries to predict a long term prevalence.Another diabetes complications
